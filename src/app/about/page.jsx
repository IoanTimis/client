		...
		<div className="min-h-screen">
			...
			<Section className="bg-white">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
					<div>
						...
						<p className="mt-3 text-black">{t('about.sub')}</p>
			...
			{/* Features */}
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
						...
						/>
						<FeatureCard
							title={t('about.features.pixel')}
							description={t('about.features.pixelDesc')}
							icon={SparklesIcon}
						/>
						<FeatureCard
			...
			{/* Story */}
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						<div className="md:col-span-2">
							...
							<p className="mt-3 text-black">{t('about.story.p1')}</p>
							<p className="mt-3 text-black">{t('about.story.p2')}</p>
						</div>
						<div className="md:col-span-1">
							<div className="rounded-lg border border-foreground/10 p-4">
								<h3 className="text-base font-semibold">{t('about.facts.title')}</h3>
								<ul className="mt-2 space-y-2 text-sm text-black list-disc list-inside">
									<li>{t('about.facts.founded')}</li>
									<li>{t('about.facts.remote')}</li>
									<li>{t('about.facts.opensource')}</li>
								</ul>
							</div>
									</div>
								</div>
